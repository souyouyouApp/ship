    ...
    <div class="table-responsive">
        ...
        <div id="toolbar">
            ...
            <form class="form-inline">
                ...
                <#--<@shiro.hasPermission name="anli:import">-->
                    <#--<div class="form-group">-->
                        <#--<div class="btn-group">-->
...
<script type="text/javascript">
    ...
    function exportAttach() {
        ...
        $.ajax({
            ...
            data: {fileId: selectedObjs[0].id,type:'ATTACHMENT','classificlevelId':2},
            async: false,
    ...
    function deleteById() {
        ...
        layer.confirm("确定删除已勾选记录？", function () {
            ...
            var load = layer.load();
            $.post('delAnli', {ids: ids.join(',')}, function (result) {
                result = JSON.parse(result)
                layer.close(load);
...
<script type="text/javascript">
    var button = '<a id="dLabel" role="button" data-toggle="dropdown" class="btn btn-white" href="javascript:;"><span id="select-title">选择案例分类</span> <span class="caret"></span></a>';
